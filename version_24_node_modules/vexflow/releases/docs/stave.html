...
Vex.Flow.Stave = (<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{
  ...
  Stave.prototype = {
    init: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(x, y, width, options)</span> </span>{
      ...
      <span class="hljs-keyword">var</span> BARTYPE = Vex.Flow.Barline.type;
      <span class="hljs-keyword">this</span>.addModifier(<span class="hljs-keyword">new</span> Vex.Flow.Barline(<span class="hljs-keyword">this</span>.options.left_bar ? BARTYPE.SINGLE : BARTYPE.NONE));  <span class="hljs-comment">// beg bar</span>
      <span class="hljs-keyword">this</span>.addEndModifier(<span class="hljs-keyword">new</span> Vex.Flow.Barline(<span class="hljs-keyword">this</span>.options.right_bar ? BARTYPE.SINGLE : BARTYPE.NONE)); <span class="hljs-comment">// end bar</span>
    },
    ...
    getOptions: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{ <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.options; },

    setNoteStartX: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(x)</span> </span>{
    ...
    getNoteEndX: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{
      <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.formatted) <span class="hljs-keyword">this</span>.format();
    ...
    setX: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(x)</span></span>{
...
this.modifiers[1].setX(this.end_x);</p>
    ...
    setMeasure: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(measure)</span> </span>{ <span class="hljs-keyword">this</span>.measure = measure; <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>; },
    ...
    getModifierXShift: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(index)</span> </span>{
      ...
      <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.getModifiers(Vex.Flow.StaveModifier.Position.BEGIN).length === <span class="hljs-number">1</span>) {
      ...
      <span class="hljs-keyword">if</span> (begBarline.getType() === Vex.Flow.Barline.type.REPEAT_BEGIN &amp;&amp;
    ...
    getLineForY: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(y)</span></span>{</pre></div>
    ...
    addModifier: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(modifier, position)</span> </span>{
    ...
    addEndModifier: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(modifier)</span> </span>{
      <span class="hljs-keyword">this</span>.addModifier(modifier, Vex.Flow.StaveModifier.Position.END);
      <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
    },</pre></div>
    ...
    setClef: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(clefSpec, size, annotation, position)</span> </span>{
      <span class="hljs-keyword">if</span> (position === <span class="hljs-literal">undefined</span>) {
        position = Vex.Flow.StaveModifier.Position.BEGIN;
      }

      <span class="hljs-keyword">this</span>.clef = clefSpec;
      <span class="hljs-keyword">var</span> clefs = <span class="hljs-keyword">this</span>.getModifiers(position, Vex.Flow.Clef.category);
    ...
    setEndClef: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(clefSpec, size, annotation)</span> </span>{
      <span class="hljs-keyword">this</span>.setClef(clefSpec, size, annotation, Vex.Flow.StaveModifier.Position.END);
      <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
    },

    setKeySignature: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(keySpec, cancelKeySpec, position)</span> </span>{
      <span class="hljs-keyword">if</span> (position === <span class="hljs-literal">undefined</span>) {
        position = Vex.Flow.StaveModifier.Position.BEGIN;
      }

      <span class="hljs-keyword">var</span> keySignatures = <span class="hljs-keyword">this</span>.getModifiers(position, Vex.Flow.KeySignature.category);
    ...
    setEndKeySignature: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(keySpec, cancelKeySpec)</span> </span>{
      <span class="hljs-keyword">this</span>.setKeySignature(keySpec, cancelKeySpec, Vex.Flow.StaveModifier.Position.END);
      <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
    },

    setTimeSignature: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(timeSpec, customPadding, position)</span> </span>{
      <span class="hljs-keyword">if</span> (position === <span class="hljs-literal">undefined</span>) {
        position = Vex.Flow.StaveModifier.Position.BEGIN;
      }

      <span class="hljs-keyword">var</span> timeSignatures = <span class="hljs-keyword">this</span>.getModifiers(position, Vex.Flow.TimeSignature.category);
    ...
    setEndTimeSignature: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(timeSpec, customPadding)</span> </span>{
      <span class="hljs-keyword">this</span>.setTimeSignature(timeSpec, customPadding, Vex.Flow.StaveModifier.Position.END);
      <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
    },

    addKeySignature: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(keySpec, cancelKeySpec, position)</span> </span>{
      <span class="hljs-keyword">this</span>.addModifier(<span class="hljs-keyword">new</span> Vex.Flow.KeySignature(keySpec, cancelKeySpec), position);
      <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
    },

    addClef: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(clef, size, annotation, position)</span> </span>{
      <span class="hljs-keyword">if</span> (position === <span class="hljs-literal">undefined</span> ||
          position === Vex.Flow.StaveModifier.Position.BEGIN) {
        <span class="hljs-keyword">this</span>.clef = clef;
      }

      <span class="hljs-keyword">this</span>.addModifier(<span class="hljs-keyword">new</span> Vex.Flow.Clef(clef, size, annotation), position);
      <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
    },
    ...
    addEndClef: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(clef, size, annotation)</span> </span>{
      <span class="hljs-keyword">this</span>.addClef(clef, size, annotation, Vex.Flow.StaveModifier.Position.END);
      <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
    },

    addTimeSignature: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(timeSpec, customPadding, position)</span> </span>{
      <span class="hljs-keyword">this</span>.addModifier(<span class="hljs-keyword">new</span> Vex.Flow.TimeSignature(timeSpec, customPadding), position);
      <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
    },
    ...
    addEndTimeSignature: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(timeSpec, customPadding)</span> </span>{
      <span class="hljs-keyword">this</span>.addTimeSignature(timeSpec, customPadding, Vex.Flow.StaveModifier.Position.END);
      <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
    },</pre></div>
        ...
        <p>Deprecated</p>
          ...
          <div class='highlight'><pre>    addTrebleGlyph: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{
      <span class="hljs-keyword">this</span>.addClef(<span class="hljs-string">'treble'</span>);
      <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
    },

    getModifiers: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(position, category)</span> </span>{
    ...
    sortByCategory: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(items, order)</span> </span>{
    ...
    format: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{
      <span class="hljs-keyword">var</span> Barline = Vex.Flow.Barline;
      <span class="hljs-keyword">var</span> begBarline = <span class="hljs-keyword">this</span>.modifiers[<span class="hljs-number">0</span>];
      <span class="hljs-keyword">var</span> endBarline = <span class="hljs-keyword">this</span>.modifiers[<span class="hljs-number">1</span>];

      <span class="hljs-keyword">var</span> begModifiers = <span class="hljs-keyword">this</span>.getModifiers(Vex.Flow.StaveModifier.Position.BEGIN);
      <span class="hljs-keyword">var</span> endModifiers = <span class="hljs-keyword">this</span>.getModifiers(Vex.Flow.StaveModifier.Position.END);
