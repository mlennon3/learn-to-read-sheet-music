...
<p>A rendering context for SVG.</p>
<p>Copyright Mohit Muthanna 2015
@author Gregory Ristow (2015)</p>

        
          <div class='highlight'><pre>
<span class="hljs-comment">/** @constructor */</span>
Vex.Flow.SVGContext = (<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{
  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">SVGContext</span><span class="hljs-params">(element)</span> </span>{
  ...
  SVGContext.prototype = {
    init: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(element)</span> </span>{</pre></div>
    ...
    create: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(svgElementType)</span> </span>{
      ...
      <span class="hljs-keyword">if</span> (cls) group.setAttribute(<span class="hljs-string">"class"</span>, SVGContext.addPrefix(cls));
      <span class="hljs-keyword">if</span> (id) group.setAttribute(<span class="hljs-string">"id"</span>, SVGContext.addPrefix(id));
...
note at ieMeasureTextFix() for details.</p>
          ...
          <div class='highlight'><pre>    iePolyfill: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{
      <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span>(navigator) !== <span class="hljs-string">"undefined"</span>) {
        ...
        <h3 id="styling-state-methods-">Styling &amp; State Methods:</h3>
          ...
          <div class='highlight'><pre>
    setFont: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(family, size, weight)</span> </span>{</pre></div>
...
how all existing modules are calling this.</p>
    ...
    setLineDash: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(lineDash)</span> </span>{
      <span class="hljs-keyword">this</span>.attributes[<span class="hljs-string">"stroke-linedash"</span>] = lineDash;
      <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
    },

    setLineCap: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(lineCap)</span> </span>{
...
apply responsive sizing attributes to the SVG.</p>
          ...
          <div class='highlight'><pre>    resize: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(width, height)</span> </span>{
    ...
    scale: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(x, y)</span> </span>{</pre></div>
...
for us to eventually move in that direction.</p>
    ...
    setViewBox: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(xMin, yMin, width, height)</span> </span>{</pre></div>
      ...
      <span class="hljs-keyword">else</span> {
        ...
        <h3 id="drawing-helper-methods-">Drawing helper methods:</h3>
          ...
          <div class='highlight'><pre>
    applyAttributes: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(element, attributes)</span> </span>{
    ...
    flipRectangle: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(args)</span> </span>{</pre></div>
        
      
        
        <p>Avoid invalid negative height attributes by
...
return it.</p>
        ...
        <p>Add negative height to Y</p>

        
          <div class='highlight'><pre>      args[<span class="hljs-number">1</span>] += args[<span class="hljs-number">3</span>];</pre></div>
        
      
        
        <p>Make the negative height positive.</p>

        
          <div class='highlight'><pre>      args[<span class="hljs-number">3</span>] = -args[<span class="hljs-number">3</span>];
    },</pre></div>
        ...
        <h3 id="shape-path-methods-">Shape &amp; Path Methods:</h3>
          ...
          <div class='highlight'><pre>
    clear: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{</pre></div>
...
from a touch point.)</p>
      ...
      <span class="hljs-keyword">while</span> (<span class="hljs-keyword">this</span>.svg.lastChild) {
        ...
        <h2 id="rectangles-">Rectangles:</h2>
          ...
          <div class='highlight'><pre>
    rect: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(x, y, width, height, attributes)</span> </span>{</pre></div>
...
flipping the rectangle on its head:</p>
          ...
          <div class='highlight'><pre>      <span class="hljs-keyword">if</span> (height &lt; <span class="hljs-number">0</span>) <span class="hljs-keyword">this</span>.flipRectangle(<span class="hljs-built_in">arguments</span>);</pre></div>
    ...
    clearRect: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(x, y, width, height)</span> </span>{</pre></div>
...
arc method.</p>
    ...
    closePath: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{
      ...
      <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
        ...
        <p>Adapted from the source for Raphael’s Element.glow</p>
          ...
          <div class='highlight'><pre>    glow: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{</pre></div>
    ...
    fill: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(attributes)</span> </span>{</pre></div>
    ...
    stroke: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{</pre></div>
      ...
      <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
        ...
        <h2 id="text-methods-">Text Methods:</h2>
          ...
          <div class='highlight'><pre>    measureText: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(text)</span> </span>{
    ...
    ieMeasureTextFix: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(bbox, text)</span> </span>{</pre></div>
...
And then subtract the overestimate from calculated width.</p>
  ...
  <span class="hljs-keyword">return</span> SVGContext;
}());</pre></div>
